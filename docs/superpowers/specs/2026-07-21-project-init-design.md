...
```
GitHub: github.com/soeasy13142/project-init
├── install.sh                           # 一键安装
...
# 方法2: 手动
curl -o .claude/skills/init/init.md https://raw.githubusercontent.com/soeasy13142/project-init/main/skill/init.md
```
